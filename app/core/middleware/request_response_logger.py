...
# From django-stubs
class _AsyncGetResponseCallable(typing.Protocol):
    def __call__(self, request: HttpRequest, /) -> typing.Awaitable[HttpResponseBase]: ...
    ...
    def __call__(self, request: HttpRequest):
        ...
        logger_extra = {
            ...
            "data": {
                ...
                "response": get_response_log_data(response),
            }
            | (
                {"session": {"before": before_session_data, "after": after_session_data}}
